...
<header class="sticky top-0 z-30 border-b border-border bg-surface-card/80 backdrop-blur-md">
    <div class="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            {{-- Quick action --}}
            <button type="button" class="hidden items-center gap-2 rounded-xl bg-brand-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-brand-700 sm:flex">
