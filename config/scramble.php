...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<'MD'
# WA Gateway API — RS Roemani

Dokumentasi OpenAPI otomatis untuk WhatsApp Gateway Rumah Sakit Roemani.

## Autentikasi

- Endpoint **Template** membutuhkan session login dashboard (`auth`).
- Endpoint **Webhook** dipanggil oleh WPPConnect Server dan dilindungi `WA_WEBHOOK_SECRET`.

## Base URL

Semua path di dokumentasi ini relatif terhadap prefix `/api`.
MD,
    ],

    'ui' => [
        'title' => 'WA Gateway API — RS Roemani',
    ],
